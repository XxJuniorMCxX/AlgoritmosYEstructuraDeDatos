...
import com.mycompany.metodosdeordenamiento.Sesion2.*;

public class SortUTP1 {
...
//        }
//        System.out.printf(" => Left=%d,Right=%d,Low=%d,High=%d,Mid=%d,Pivot=%s\n", left, right, low, high,mid, pivot.toString());
...
//            System.out.printf("INIT GAP => ");
//            for (int ii = 0; ii < data.length; ii++) {
//                System.out.printf(data[ii] + "-");
//            }
